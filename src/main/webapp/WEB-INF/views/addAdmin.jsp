                ...
                <form:form modelAttribute="admin" method="POST">
                    ...
                    <div class="columns">
                        <div class="item">
                            ...
                            <form:input path="firstName" required="true" id="firstName" type="text" name="firstName"/>
                            <form:errors path="firstName" cssClass="error"/>
                        </div>
                        <div class="item">
                            <label for="lastName"> Last Name<span>*</span></label>
                            <form:input path="lastName" required="true" id="lastName" type="text" name="lastName"/>
                            <form:errors path="lastName" cssClass="error"/>
                        </div>

                        <div class="item">
                            <label for="email">Email<span>*</span></label>
                            <form:input path="email" required="true" id="email" type="email" name="email"/>
                            <form:errors path="email" cssClass="error"/>
                        </div>
                        <div class="item">
                            <label for="password">Password<span>*</span></label>
                            <form:input path="password" required="true" id="password" type="text" name="password"/>
                        ...
                        <div class="item">
                            ...
                            <form:input path="dateOfBirth" id="dateOfBirth" type="date" name="dateOfBirth"
                                        placeholder="yyyy-MM-dd" value="${date}" required="true"
