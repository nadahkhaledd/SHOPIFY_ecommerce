                                        ...
                                        <table>
                                            ...
                                            <c:if test="${!empty addresses}">
                                                ...
                                                <button type="button" class="edit-button"
                                                    onclick="location.href='${pageContext.request.contextPath}/address/update/1?id=${address.id}'"
                                                    style="outline:0;border:0;background-color: #fff;">
                                                <i class="fa fa-pen fa-xs"></br>Edit</i>
                                                </button>
                                                <button type="button" class="delete-button"
                                                    onclick="location.href='${pageContext.request.contextPath}/address/delete/1?id=${address.id}'"
                                                    style="outline:0;border:0;background-color: #fff;">
