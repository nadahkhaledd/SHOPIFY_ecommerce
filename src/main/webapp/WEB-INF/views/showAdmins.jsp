...
<layout:extends name="base">
    ...
    <head>
        ...
        <title><layout:put block="title" type="REPLACE">Admins</layout:put></title>
    </head>
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${admins}" var="admin">
                            <tr>
                                ...
                                <th><a href="/e-commerce/admin/updateAdmin/${admin.id}" class="btn" style="background: purple; color:white">Update</a></th>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                    <div>
                        <a class="btn btn-success" href="/e-commerce/admin/addAdmin">Add</a>
                    </div>
                </div>
            </div>
        </div>
