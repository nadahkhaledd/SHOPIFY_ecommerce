	...
	<div class="form-container sign-in-container">
        <form:form modelAttribute="user" method="POST">
			<h1>Sign Up</h1>
                ...
                <ul class="nav">
                  <li><a href="#clients"><form:radiobutton path="gender" value="male" id="male" name="gender"/>
                                                                <label for="male" class="radio"><span>male</span></label>
                                                           </a></li>
                  <li><a href="#contact"></a><form:radiobutton path="gender" value="female" id="female" name="gender"/>
